...
function main(config) {
  ...
  config["geox-url"] = {
    geoip:
      "https://mirror.ghproxy.com/https://github.com/Moli-X/Tool/raw/X/GeoIP/geoip-lite.dat",
    geosite:
      "https://mirror.ghproxy.com/https://github.com/Moli-X/Tool/raw/X/GeoIP/geosite.dat",
  ...
  config["proxy-groups"] = [
    ...
    },
    {
      ...groupBaseArea,
      name: "低倍节点",
      icon: "https://fastly.jsdelivr.net/gh/Koolson/Qure@master/IconSet/Color/Ring.png",
      filter: "(?i)0.20x",
    },
    {
      ...groupBaseArea,
      ...
      "exclude-filter":
        "群|邀请|返利|循环|官网|客服|网站|网址|获取|订阅|流量|访问|加入|(\b(USE|Panel|Channel|Author)\b)",
    },
  ];
  ...
  config["rule-providers"] = {
    ...
    ProxyGFW: {
      ...ruleProviderText,
      url: "https://github.com/Moli-X/Tool/raw/X/Clash/Rules/ProxyGFW.list",
